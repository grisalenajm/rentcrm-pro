...
export class OrganizationService {
  ...
  async update(id: string, dto: any) {
    const data: any = {};
    const stringFields = ['name','nif','address','phone','email','logo','smtpHost','smtpUser','smtpFrom','currency','dateFormat','sesUsuarioWs','sesPasswordWs','sesCodigoArrendador','sesEndpoint','paperlessUrl','paperlessToken','paperlessSecret'];

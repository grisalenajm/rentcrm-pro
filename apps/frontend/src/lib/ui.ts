...
export const inputCls =
  'w-full bg-[#0f0f1a] border border-white/10 rounded-xl px-4 py-2.5 text-white placeholder-white/30 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all disabled:opacity-40 disabled:cursor-not-allowed';
